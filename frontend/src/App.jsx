...
                  {/* Campo de Busca - Mover para fora da Grid do formulário, mas ainda dentro da Box principal */}
                  <Grid container spacing={2} justifyContent="center" sx={{ mt: 4, mb: 2 }}> {/* Novo Grid para o campo de busca com espaçamento superior */}
